            ...
            <div class="grid h-full gap-x-4 grid-cols-[2fr_4fr] mt-6">
                <div class="bg-white h-full flex flex-col rounded-xl mt-4">
                    <div class="rounded-xl bg-slate-300">
                        <img class="w-full min-h-[10rem] m-0 p-2" id="profile_picture" :src="userProfile"
                            alt="Profile Picture">
                    </div>
                    <button
                            ...
                            <table class="w-full text-sm text-left rtl:text-right">
                                <tbody>
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4">
                                            <input type="text" id="fullname" name="fullname" v-model="profile.fullname"
                                                autocomplete="off" @input="changed = true"
                                    ...
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4 relative">
                                            <input type="text" id="date_of_birth" name="date_of_birth" datepicker
                                                datepicker-format="yyyy-mm-dd" v-model="profile.date_of_birth"
                                                autocomplete="off" @change="changed = true"
                                                class="h-12 bg-gray-50 border border-[#376F7E] text-[#898383] text-sm rounded-lg focus:ring-0 focus:border-[#376F7E] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-400 dark:focus:border-orange-400"
                                        ...
                                        <td class="px-6 py-4 flex" colspan="2">
                                            <div class="flex items-center mr-5">
                                                <input id="genderMale" type="radio" name="gender" value="male"
                                                    @click="profile.gender = 'male'; changed = true"
                                    ...
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4 relative">
                                            <input type="password" id="old_password" name="old_password"
                                                v-model="old_password" autocomplete="off" @input="changed = true"
                                                class="h-12 bg-gray-50 border- border-[#376F7E] text-[#898383] text-sm rounded-lg focus:ring-0 focus:border-[#376F7E] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-400 dark:focus:border-orange-400"
...
export default {
    ...
    computed: {
        userProfile() {
            return this.profile.photo || '/img/assets/icon/icon_user.svg';
        }
    },
    data() {
        return {
