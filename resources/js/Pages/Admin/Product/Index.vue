<template>
    <Layout title="Product">
      <div class="bg-[#EFEFEF] border-gray-200 rounded-lg overflow-y-auto">
        <!-- Tabs -->
        <div class="mb-3">
          <ul class="flex flex-wrap -mb-px text-xs md:text-[13px] lg:text-lg font-bold text-center text-black gap-x-4 md:gap-x-2 lg:gap-x-16" role="tablist">
            <!-- Product Tab -->
            <li class="ml-auto" role="presentation">
              <button @click="setActiveTab('product')"
                :class="[
            ...
            <li class="mr-auto" role="presentation">
              <button @click="setActiveTab('carousel')"
                :class="[
                  'inline-block px-4 pt-4 pb-1 border-b-2 rounded-t-lg',
