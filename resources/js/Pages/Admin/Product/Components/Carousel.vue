<template>
    <div class="h-full flex flex-col">
      ...
      <div
        ...
        <div v-for="carousel in carousels" :key="carousel.id"
          ...
          <div class="w-full h-2/3 bg-cover">
            ...
            <video v-else-if="carousel.media_type === 'video'" :src="carousel.media"
              class="w-full h-full object-cover" controls muted />
            <iframe v-else-if="carousel.media_type === 'youtube'" :src="carousel.media"
      ...
      <Modal :show="showAddModal" @close="showAddModal = false">
        <div class="bg-white w-[30vw] h-auto rounded-lg shadow p-4">
          <button @click="showAddModal = false"
            class="absolute bg-black w-5 h-5 flex items-center justify-center rounded-full pb-3 -top-2 -right-2">
            <p class="m-auto text-white text-sm">X</p>
          </button>
          <form @submit.prevent="addCarousel" class="flex flex-col h-full text-center py-8 px-5">
            <div class="relative w-full h-56 bg-gray-200 rounded-2xl">
              ...
              <label @click="triggerAddMediaInput" class="absolute bottom-3 right-3 bg-white p-2 rounded-lg cursor-pointer">
