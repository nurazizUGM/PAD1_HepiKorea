<template>
  <div class="h-full flex flex-col">
      ...
      <div v-for="category in categories" :key="category.id"
        ...
        <div class="flex mt-auto mx-4 mb-4">
          <button @click="openEditModal(category)" class="mr-auto">
            <img src="/img/assets/icon/icon_admin_category_edit.svg" alt="edit" class="w-6 lg:w-7 h-6 lg:h-7" />
          </button>
          <button @click="openDeleteModal(category.id)" class="ml-auto">
            <img src="/img/assets/icon/icon_admin_category_trash.svg" alt="delete" class="w-6 lg:w-7 h-6 lg:h-7" />
          </button>
        </div>
      </div>
    </div>
    ...
    <Modal :show="showAddModal" @close="showAddModal = false">
      <div class="bg-white w-[261px] h-[511px] md:w-[646px] md:h-[350px] lg:w-[747px] lg:h-[400px] rounded-lg shadow p-3 md:p-6">
            ...
            <form @submit.prevent="addCategory" class="flex flex-col h-full text-center md:px-5">
              ...
              <div class="relative w-full mt-2 md:mt-5">
                ...
                <label @click="triggerAddFileInput"
                  ...
                  <img src="/img/assets/icon/icon_admin_category_upload.svg" alt="Upload Icon" class="h-5 w-5 lg:h-8 lg:w-8" />
                </label>
              </div>
              <h1 class="text-orange-400 text-sm lg:text-xl font-semibold text-left mt-2 md:mt-5">Category Name</h1>
