        ...
        <div v-if="dropdowns.sortBy"
          ...
          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
            ...
            <li @click="selectSortBy('highest_price')">
              <a href="#" class="block px-4 py-2 text-[10px] md:text-xs lg:text-lg hover:bg-gray-100">Highest
                Price</a>
            </li>
            <li @click="selectSortBy('lowest_price')">
              <a href="#" class="block px-4 py-2 text-[10px] md:text-xs lg:text-lg hover:bg-gray-100">Lowest
                Price</a>
            </li>
