...
const submitSearch = () => {
  ...
  Inertia.get(route('product.index'), { search: search.value }, { preserveState: true });
};
...
<template>
  ...
  <div class="font-poppins w-screen h-screen overflow-y-auto overflow-x-hidden no-scrollbar">
    ...
    <nav class="fixed top-0 z-40 w-full h-fit bg-white border-b border-gray-200 shadow-lg">
      <div class="px-5 py-3 md:px-1 md:py-1 lg:px-5 lg:pl-3 lg:py-3">
        <div class="flex flex-col md:flex-row gap-y-5 items-center justify-between align-middle">
          ...
          <div
            class="gap-x-5 items-center justify-around mx-auto md:ml-auto md:mr-5 align-middle"
            :class="{ 'hidden md:flex': !showMobileNav, 'flex': showMobileNav }"
              ...
              >
                <ul class="py-1">
                  <li v-if="isAdmin">
                    ...
                    >
                      <img
                        src="/img/assets/icon/icon_dashboard_admin.svg"
                        alt=""
                  ...
                  <li v-else>
                    ...
                    >
                      <img
                        src="/img/assets/icon/icon_dashboard_customer.svg"
                        alt=""
                        class="w-5 h-5 grayscale group-hover:grayscale-0"
                      />
                    ...
                    <Link
                      :href="route('auth.address')"
                      class="flex flex-row items-center px-4 py-2 text-lg font-semibold text-[#B7B7B7] hover:bg-gray-100 group"
                    >
                      <img
                        src="/img/assets/icon/icon_address.svg"
                        alt=""
                        class="w-5 h-5 grayscale group-hover:grayscale-0"
                      />
                    ...
                    >
                      <img
                        src="/img/assets/icon/icon_history.svg"
                        alt=""
                        class="w-5 h-5 grayscale group-hover:grayscale-0"
                      />
                  ...
                  <li>
                    ...
                    >
                      <img
                        src="/img/assets/icon/icon_dashboard_logout.svg"
                        alt=""
                        class="w-5 h-5 grayscale group-hover:grayscale-0"
                      />
    ...
    <div v-if="page.props.appDebug" class="absolute top-24 right-8 z-60">
      <!-- Error Alerts -->
      <div v-for="(error, index) in Object.values(errors)" :key="`error-${index}`" :id="`alert-error-${index}`" class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50" role="alert">
        ...
        <button
          ...
          @click="closeAlert(`alert-error-${index}`)"
          aria-label="Close"
        >
      ...
      <div v-if="message" id="alert-message" class="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50" role="alert">
        <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          <path
            d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"
          />
