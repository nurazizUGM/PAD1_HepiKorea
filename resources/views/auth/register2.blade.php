...
<div class="bg-white h-auto max-w-lg p-10 m-auto shadow-lg mt-12 rounded-2xl">
    ...
    <form action="">
        ...
        <div class="relative w-full mt-5">
            ...
            <span class="absolute inset-y-0 right-0 pr-6 flex items-center">
                <img id="togglePassword" src="{{ asset('img/assets/icon/icon_hide_eye.png') }}" alt="eye hide Icon" class="h-6 w-6 cursor-pointer">
            </span>
        </div>
        ...
        <div class="relative w-full mt-5">
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
                <img src="{{ asset('img/assets/icon/icon_lock.png') }}" alt="User Icon" class="h-6 w-6">
            </span>
            <input id="confirmPassword" type="password" placeholder="Confirm Password"
                class="pl-12 w-full rounded-xl bg-[#EFEFEF] shadow-md border-none h-14 focus:outline-none focus:ring-0">
            <!-- show/hide password -->
            <span class="absolute inset-y-0 right-0 pr-6 flex items-center">
                <img id="toggleConfirmPassword" src="{{ asset('img/assets/icon/icon_hide_eye.png') }}" alt="eye hide Icon" class="h-6 w-6 cursor-pointer">
            </span> 
        </div>
    ...
    <p class="text-sm font-semibold text-center text-black">Have an account? <a href="#"class="text-blue-600">Login</a></p>
    ...
    <!-- button login google -->
    <button class="w-full flex items-center justify-center bg-[#EFEFEF] h-12 rounded-xl mb-5 text-2xl font-bold text-black mt-10">
