    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full flex flex-col pl-7 pr-2 py-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        class="flex items-center ms-0.5 p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <img src="{{ asset('img/assets/icon/icon_dashboard_product.svg') }}" alt="product Icon"
                            class="h-6 w-6 grayscale group-hover:grayscale-0">
                        <span
                            class="flex-1 ms-4 whitespace-nowrap text-[#B7B7B7] group-hover:text-orange-400">Product</span>
                    </a>
                </li>
                <!-- Order -->
                <li>
                    <a href="#"
                        ...
                        <img src="{{ asset('img/assets/icon/icon_dashboard_order.svg') }}" alt="product Icon"
                            class="h-7 w-7 grayscale group-hover:grayscale-0">
                        <span
                            class="flex-1 ms-3 whitespace-nowrap text-[#B7B7B7] group-hover:text-orange-400">Order</span>
                    </a>
                </li>
                <!-- Analytic -->
                <li>
                    <a href="#"
                        ...
                        <img src="{{ asset('img/assets/icon/icon_dashboard_analytic.svg') }}" alt="product Icon"
                            class="h-7 w-7 grayscale group-hover:grayscale-0">
                        <span
                            class="flex-1 ms-2.5 whitespace-nowrap text-[#B7B7B7] group-hover:text-orange-400">Analytic</span>
                    </a>
                </li>
                <!-- Customer -->
                <li>
                    <a href="#"
                        ...
                        <span
                            class="flex-1 ms-3 whitespace-nowrap text-[#B7B7B7] group-hover:text-orange-400">Customer</span>
                    </a>
                </li>
                <!-- FAQ -->
                <li>
                    <a href="#"
                        ...
                        <img src="{{ asset('img/assets/icon/icon_dashboard_faq.svg') }}" alt="product Icon"
                            class="h-7 w-7 scale-90 grayscale group-hover:grayscale-0">
                        <span
                            class="flex-1 ms-3 whitespace-nowrap text-[#B7B7B7] group-hover:text-orange-400">FAQ</span>
                    </a>
                </li>
            </ul>
            <!-- Logout -->
