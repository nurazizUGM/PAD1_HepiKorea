...
@section('content')
    ...
    <script>
        ...
        //     const container = document.querySelectorAll('.product-slider-container');
        //     container.scrollBy({
        //         top: 0,
        //         left: 200, // Jarak scroll ke kanan
        ...
        //     const walk = (x - startX) * 2; // Sesuaikan faktor kecepatan
        //     container.scrollLeft = scrollLeft - walk;
        // });

        // 

        // // Scroll kanan untuk Best Seller
        // function scrollRightBestSeller() {
        ...
        // // Scroll kiri untuk Best Seller
        // function scrollLeftBestSeller() {
        //     const container = document.getElementById('best-seller-container');
        //     container.scrollBy({
        //         top: 0,
        //         left: -200, // Jarak scroll ke kiri
        ...
        // // Drag-to-scroll untuk Best Seller
        // const bestSellerContainer = document.getElementById('best-seller-container');
        // let isDownBestSeller = false;
        // let startXBestSeller;
        // let scrollLeftBestSeller;

        // bestSellerContainer.addEventListener('mousedown', (e) => {
        //     isDownBestSeller = true;
        //     startXBestSeller = e.pageX - bestSellerContainer.offsetLeft;
        //     scrollLeftBestSeller = bestSellerContainer.scrollLeft;
        // });

        // bestSellerContainer.addEventListener('mouseleave', () => {
        //     isDownBestSeller = false;
        // });
        ...
        // bestSellerContainer.addEventListener('mousemove', (e) => {
        //     if (!isDownBestSeller) return;
        //     e.preventDefault();
        //     const x = e.pageX - bestSellerContainer.offsetLeft;
        //     const walk = (x - startXBestSeller) * 2; // Sesuaikan faktor kecepatan
        //     bestSellerContainer.scrollLeft = scrollLeftBestSeller - walk;
        // });

        // // Scroll kanan untuk New Arrival
        // function scrollRightNewArrival() {
        ...
        // // Scroll kiri untuk New Arrival
        // function scrollLeftNewArrival() {
        //     const container = document.getElementById('new-arrival-container');
        //     container.scrollBy({
        //         top: 0,
        //         left: -200, // Jarak scroll ke kiri
        ...
        // // Drag-to-scroll untuk New Arrival
        // const newArrivalContainer = document.getElementById('new-arrival-container');
        // let isDownNewArrival = false;
        // let startXNewArrival;
        // let scrollLeftNewArrival;

        // newArrivalContainer.addEventListener('mousedown', (e) => {
        //     isDownNewArrival = true;
        //     startXNewArrival = e.pageX - newArrivalContainer.offsetLeft;
        //     scrollLeftNewArrival = newArrivalContainer.scrollLeft;
        // });

        // newArrivalContainer.addEventListener('mouseleave', () => {
        //     isDownNewArrival = false;
        // });
        ...
        // newArrivalContainer.addEventListener('mousemove', (e) => {
        //     if (!isDownNewArrival) return;
        //     e.preventDefault();
        //     const x = e.pageX - newArrivalContainer.offsetLeft;
        //     const walk = (x - startXNewArrival) * 2; // Sesuaikan faktor kecepatan
        //     newArrivalContainer.scrollLeft = scrollLeftNewArrival - walk;
        // });
    </script>
@endsection
