...
@section('content')
    <div class="w-full w-max[100%] h-full rounded-3xl bg-[#EFEFEF] py-2 px-14">
        ...
        <div class="overflow-y-scroll no-scrollbar h-[80vh] mt-2 mb-64">
            {{-- product card container --}}
            <div class="relative w-full h-fit grid grid-cols-3 gap-x-5 gap-y-5 mt-2 mb-72">
                @for ($i = 0; $i < 6; $i++)
                    {{-- product card --}}
            ...
            <div class="fixed w-[156vh] h-[25vh] bg-white rounded-2xl bottom-10 left-28 z-10 flex flex-col py-5 px-10">
                ...
                <div class="w-full h-fit flex flex-row my-auto">
                    ...
                    <div class="w-fit h-full flex flex-row">
                        ...
                        {{-- button delete --}}
                        <button class="bg-white hover:bg-slate-100 outline outline-2 outline-[#3E6E7A] rounded-2xl inline-flex my-auto ml-10 py-2 px-12">
