            ...
            <div class="w-full h-full flex flex-col gap-y-4 mt-4">
                ...
                <div class="w-full h-fit bg-white rounded-2xl shadow-lg p-4">
                    ...
                    <div class="w-ful h-full flex flex-row mt-3">
                        {{-- image product --}}
                        <img src="{{ asset('img/example/admin_order_img_phone.png') }}" alt="img_product" class="h-20 object-contain">
                        ...
                        {{-- Status of product --}}
                        <h1 class="text-[#3E6E7A] text-xl font-semibold my-auto ml-auto">Your product has been confirmed!</h1>
                    </div>
                </div>
                {{-- end of Notification --}}
                @endfor
