...
{{-- send order detail --}}
<div id="send-order-{{ $id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="bg-white w-[45vw] rounded-xl shadow">
            <div class="relative w-full px-12 py-10 flex flex-row">
                ...
                <div class="w-[100%] h-[100%] rounded-lg">
                    ...
                    <form action="{{ route('admin.order.send', $id) }}" method="POST" class="w-full max-h-[95%]">
                        @csrf
                        @php
                            $shipment = App\Models\OrderShipment::where('order_id', $id)->first();
                        @endphp
                            ...
                            <tr>
                                <td>
                                    <label for="" class="text-base text-black text-opacity-50">Expedition
                                        Name</label>
                                    <input type="text" name="shipment_service" readonly
                                        value="{{ $shipment->shipment_service }}"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" name="price" readonly
                                        value="Rp {{ number_format($shipment->price ?? 0, 0, ',', '.') }},-"
                                        class="w-full rounded-lg bg-white shadow-md border-none focus:border-none focus:ring-0">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="" class="text-base text-black text-opacity-50">Tracking
                                        Code</label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input datepicker id="send-datepicker-{{ $id }}"
