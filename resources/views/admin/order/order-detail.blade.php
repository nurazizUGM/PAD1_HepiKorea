...
@section('content')
    <div class="w-full w-max[100%] h-full rounded-3xl bg-[#EFEFEF] py-8 px-10 overflow-y-scroll no-scrollbar">
        {{-- shipping address container --}}
        <div class="w-full h-full max-h-44 overflow-hidden rounded-3xl bg-white flex flex-col pt-3 pb-4 px-10 transition-all duration-1000"
        ...
        <div class="w-full h-fit rounded-3xl bg-white flex flex-col py-3 px-10 mt-6">
            <h1 class="text-black font-semibold text-2xl">Product Ordered</h1>

            <div class="w-full h-fit flex flex-col gap-y-5">
        ...
        {{-- checkout container --}}
        <div class="w-full h-fit rounded-3xl bg-white flex flex-col py-5 px-10 mt-6">
