...
<div class="flex flex-col flex-wrap p-4 border-2 bg-[#EFEFEF] border-gray-200 rounded-lg dark:border-gray-700 w-full ">
    <div class="flex items-center w-full mb-4">
        ...
        {{-- Button Add FAQ --}}
        <button data-modal-target="faq-add-modal" data-modal-toggle="faq-add-modal" class="rounded-full mb-8 bg-orange-400 w-8 hover:bg-orange-500 focus:bg-white" type="button">
    ...
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-fit max-w-2xl max-h-full">
            <!-- Modal content -->
            <div class="bg-white w-[40vw] h-[75vh] rounded-lg shadow overflow-y-auto">
        ...
        <div class="relative p-4 w-fit max-w-2xl max-h-full">
            ...
            <div class="bg-white w-[40vw] h-[75vh] rounded-lg shadow overflow-y-auto">
                <div class="relative w-full h-full flex flex-col">
                    ...
                    <div class="w-full h-full flex flex-col">
                        <form action="" method="" class="flex flex-col h-full text-center py-2 px-5">
                            <input type="text" placeholder="Edit FAQ Title" name="" id=""
                                class="rounded-2xl w-full bg-gray-200 hover:bg-gray-300 h-14 pl-5 pr-4 cursor-pointer mt-5 placeholder:text-black border-0 focus:outline-none focus:ring-0">
                            <textarea placeholder="Edit FAQ content ..." name="" id="" rows="12"
                                class="rounded-2xl w-full bg-gray-200 hover:bg-gray-300 pl-5 pr-4 cursor-pointer mt-5 placeholder:text-black placeholder:font-semi border-0 focus:outline-none focus:ring-0">
                            </textarea>
                            <button type="submit" data-modal-hide="carousel-edit-modal"
                                class="bg-orange-400 hover:bg-orange-500 text-white font-semibold mt-auto mx-auto inline-block w-1/2 h-14 rounded-3xl">Save</button>
