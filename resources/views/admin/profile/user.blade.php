                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark :bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <input type="text" id="date_of_birth" name="date_of_birth" value="{{ $user->date_of_birth }}"
                                            class="h-14 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-400 focus:border-orange-400 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-400 dark:focus:border-orange-400"
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 flex" colspan="2">
                                        <div class="flex items-center mr-5">
                                            <input id="genderMale" type="radio" name="gender" value="male" form=""
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    ...
                                    <td class="px-6 py-4 relative">
                                        ...
                                        <span class="absolute inset-y-0 right-4 pr-3">
                                            ...
                                            <button type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
@section('script')
    <script>
        ...
        function cancel() {
            ...
            $('input[name="gender"][value!="{{ $user->gender }}"]').attr('checked', false); // Menghapus centang pada jenis kelamin yang lain
        ...
        cancel(); // Memanggil fungsi cancel saat halaman dimuat untuk mengatur tampilan awal
        ...
        $('#new_password').on('input', function() {
            if ($('#new_password').val() != '') { // Jika password baru diisi
                ...
                $('#new_password_confirmation').attr('required', 'required'); // Jadikan konfirmasi password baru wajib diisi
            } else {
                $('#old_password').removeAttr('required'); // Hapus keharusan untuk password lama
                $('#new_password_confirmation').removeAttr('required'); // Hapus keharusan untuk konfirmasi password baru
            }
        });
        ...
        $('.btn-show-password').click(function() {
            ...
            const type = input.attr('type') === 'password' ? 'text' : 'password'; // Ubah tipe input antara 'password' dan 'text'
            input.attr('type', type); // Setel tipe input
            // Mengubah ikon mata sesuai dengan tipe input
            $(this).find('img').attr('src', type === 'password' ?
                '{{ asset('img/assets/icon/icon_hide_eye.svg') }}' : // Ganti dengan ikon sembunyikan jika tipe adalah password
                '{{ asset('img/assets/icon/icon_show_eye.svg') }}'); // Ganti dengan ikon tampilkan jika tipe adalah text
        });
    </script>
@endsection
